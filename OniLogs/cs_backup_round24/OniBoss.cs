...
public class OniBoss : MonoBehaviour
{
    ...
    [Tooltip("Prefab spawned at the swing's strike moment. Drop the effect you want here — it is spawned unparented and destroyed after Swing Wave VFX Lifetime. Empty = the wave still deals its damage, with no visuals.")]
