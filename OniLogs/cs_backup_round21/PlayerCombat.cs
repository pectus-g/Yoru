...
public class PlayerCombat : MonoBehaviour
{
    ...
    [Tooltip("ROUND 19. The same, for the 4-LEG flip. Its clip has a longer crouch than the 2-leg one, which is why a single shared value fixed one variant and not the other — the 4-leg still waited at the start with 0.08. 0.18 skips roughly a quarter of its wind-up.")]
    [SerializeField] private float dodge4LegSkipWindup = 0.18f;
