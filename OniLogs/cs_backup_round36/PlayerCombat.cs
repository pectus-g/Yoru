...
public class PlayerCombat : MonoBehaviour
{
    ...
    [Tooltip("ROUND 35. OFF. Nothing turns Yoru but the player. Every hit used to spin her round to face whatever struck her, which meant the game was taking her facing away mid-fight — she would end an exchange pointing somewhere you never asked for. She still FEELS the hit: the reaction animation, the flinch and the wave's impact all play as before, they just no longer come with a free rotation.")]
    [SerializeField] private bool hitReactionFacesAttacker = false;
