...
public class SwingWaveProjectile : MonoBehaviour
{
    ...
    /// <summary>
    /// ROUND 39: the club reached her after this wave was already released — her rule says the
    /// club's hit cancels the swing's wave, so it stops being able to hurt and dissolves where it
    /// is. (BeginDissolve marks it spent; calling this twice is harmless.)
    /// </summary>
